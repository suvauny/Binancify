...
class DeveloperPreview {
    ...
    let stat1 = StatModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.34)
    let stat2 = StatModel(title: "Total Volume", value: "$1.23Tr")
    let stat3 = StatModel(title: "Portfolio Value", value: "$50.4K", percentageChange: -12.34)
